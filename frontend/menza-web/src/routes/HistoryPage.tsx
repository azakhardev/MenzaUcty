...
const HistoryPage: React.FC = () => {
    ...
    const dataMessage = filteredData.length === 0 ?
        <div className="text-center p-8 text-gray-500 bg-white rounded-lg shadow-md">V tomto měsíci nemáte žádné objednávky.</div> :
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center bg-white p-4 rounded-lg shadow-md mb-6">
                    ...
                    <div className="relative mb-4 sm:mb-0 sm:mr-4">
                        ...
                        >
                            {selectedYear}
                            <svg className={`w-4 h-4 ml-2 transition-transform ${isYearDropdownOpen ? 'rotate-180' : 'rotate-0'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg>
                        </button>

                        {isYearDropdownOpen && (
                            <div className="absolute top-full mt-2 w-full max-h-48 overflow-y-auto bg-white rounded-lg shadow-xl border border-gray-200 z-10">
                    ...
                    <div className="flex justify-around bg-gray-100 p-2 rounded-lg shadow-inner flex-wrap w-full sm:w-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-6 h-full">
                    ...
                    <div className="w-full lg:w-1/3 bg-white p-6 rounded-lg shadow-2xl border border-gray-100 h-fit lg:sticky lg:top-4">
